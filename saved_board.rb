...
class Board
  ...
  attr_reader :equals_nums_rows, :a_row, :b_row, :c_row, :d_row, :two_ship_player_coords, :two_ship_computer_coords, :three_ship_player_coords, :three_ship_computer_coords, :player_shot_number, :computer_shot_number

  attr_accessor :game_board, :display_board, :game_timer
